...
local FastAttack = {'Normal Attack','Fast Attack','Super Fast Attack','Hutao Killer Attack}
	...
	elseif _G.FastAttackFaiFao_Mode == "Hutao Killer Attack" then
		_G.Fast_Delay = 0.0000000000000000001
	end
end)
